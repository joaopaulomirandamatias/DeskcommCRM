...
export const pacingKnobsUpdateSchema = z
  .object({
    ...
    human_delay_base_ms: z
      .number()
      .int()
      .min(0)
      .max(KNOB_BOUNDS.humanDelayBaseMaxMs)
      .nullable()
      .optional(),
    human_delay_ms_per_char: z
      .number()
      .int()
      .min(0)
      .max(KNOB_BOUNDS.humanDelayMsPerCharMax)
      .nullable()
      .optional(),
    human_delay_min_ms: z
      .number()
      .int()
      .min(0)
      .max(KNOB_BOUNDS.humanDelayMinMaxMs)
      .nullable()
      .optional(),
    human_delay_max_ms: z
      .number()
      .int()
      .min(0)
      .max(KNOB_BOUNDS.humanDelayMaxMaxMs)
      .nullable()
      .optional(),
